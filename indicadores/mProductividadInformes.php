	...
	?>
<h3 class="bg-light text-dark">Tabla Indicador Productividad Informes COORESPONSABLES</h3>
							...
							for($i=1; $i<=12; $i++){
								...
								<td align="center">
									<?php 
										...
										$valor = 12;
										$CodInforme = '';
										$SQL = "SELECT * FROM AmInformes Where cooResponsable = '".$rowUsr['usr']."' and month(fechaInforme) = '".$i."' and year(fechaInforme) = '".$pAgno."' Order By CodInforme";
										$bdAm=$link->query($SQL);
