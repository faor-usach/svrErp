											...
											switch ($i) {
												case 1:
													echo '<td align="right">';
															...
															$result  = mysql_query("SELECT * FROM SolFactura WHERE Estado = 'I' and year(fechaSolicitud) = $Agno and IdProyecto = '".$rowPr['IdProyecto']."'");
...
*/										
										$sSue[5] 	= $tSue18;
										// Total Acumulado Proyecto IGT-1118 
										//if(($tSue + $tTot + $tBru) > 0){
										if($tSue18 > 0){
...
*/										
										// Total General Acumulado Proyecto IGT-19
										//if(($tSue + $tTot + $tBru) > 0){
										if($tSue19 > 0){
							...
							<?php
								switch ($i) {
									case 1:
										...
										//$facturasSPAgno = $facturasSPAgno18 + $facturasSPAgno19;
										if($facturasSPAgno > 0){
