<?php
	...
	if(isset($_POST[cabezeraCorreo])) 	{	$cabezeraCorreo	= $_POST[cabezeraCorreo]; 	}
	...
	if(isset($_POST[enviarCorreoEncuesta])){
		...
		$msgCorreo  .= '<pre style="font-size:12px; font-family:Verdana, Arial, Helvetica, sans-serif;">'.$cabezeraCorreo.'</pre><br>';
		
		$msgCorreo .= '
						<a style="font-size:18px; text-decoration:none;" href="http://erp.simet.cl/encuesta/verEncuesta.php?nEnc='.$nEnc.'&RutCli='.$RutCli.'" title="Haz clic aquí...">
							[Haz Clic aquí para contestar Encuesta]
						</a><br><br>
					';
		...
		$msgCorreo .= 'Celular: 585 92 730<br>';
				    ...
				    $cabeceras .= "From: \"".$nomEnc."\" <".$EmailDepto.">\n";

		//$cabeceras .= "From: ".$nomEnc." SIMET-USACH <".$EmailDepto."> \r\n"; 
		$cabeceras .= "Bcc: hector.bruna@usach.cl, francisco.olivares.rodriguez@gmail.com \r\n"; 

					//$cabeceras .= "From: ".$_POST[nombre]." (Mod. Contacto SIMET)<".$_POST[email]."> \r\n"; 
