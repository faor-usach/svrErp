					  ...
					  <tr>
						<td colspan="5" align="center" class="txtGrandeSub">
								...
								<span style="text-align:justify; padding:20px;">
									Le rogamos tengan la amabilidad de cumplimentar los apartados que consideren oportunos con relación al contrato / servicio que hemos realizado para Uds.
								</span>
						...
						<td colspan="4" class="tMed">
							...
							<table width="100%" border="0" style="padding:5px; ">
								<tr>
									...
									<td>Valoración de la ASISTENCIA COMERCIAL (visitas, competencia, rapidez de respuesta, amabilidad, etc.)</td>
									<td valign="middle">
