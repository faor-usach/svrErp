	...
	<div id="cajaRegistraPruebas">
		...
		<table width="50%"  border="0" cellpadding="0" cellspacing="0" id="tablaDatosAjax">
			...
			<tr>
			  ...
			  <td colspan="2" valign="top" bgcolor="#CCCCCC" class="lineaDerBot"><strong>Valor UF </strong><strong><!-- 					<input name="Atención" 		id="Atencion" 		type="text" size="50" value="<?php echo $Atencion; ?>" 		style="font-size:12px; font-weight:700;"> -->    			  
              </strong></td>
		    </tr>
			<tr>
