						...
						<table class="table table-primary table-hover table-bordered">
							...
							<tbody>
								<tr ng-repeat="Items in dataItems"
									...
									<td class="default-color">
										...
										<div ng-if="Moneda == 'P'">
											<input 	type="text" 
													size="5"
													maxlength="5" 
													ng-change="actualizaDatosItems(Items.nLin, Items.Cantidad, Items.unitarioUF, Items.unitarioP, Items.unitarioUS, Items.NetoUF, Items.Neto, Items.NetoUS)"
									...
									<td class="default-color">
										<div ng-if="Moneda == 'U'">
											{{Items.NetoUF = Items.Cantidad * Items.unitarioUF  | number:2}}
										</div> 		
										<div ng-if="Moneda == 'P'">
											{{Items.Neto = Items.Cantidad * Items.unitarioP | number:2}}
										</div> 		
										<div ng-if="Moneda == 'D'">
											{{Items.NetoUS | number:2}}
										</div> 		
									</td>
									<td class="default-color">
							...
							<tfoot>
								<tr>
									<td colspan="4" rowspan="3" class="default-color">
										{{res}}
									</td>
									<td>
										Neto 
									...
									<td> 
										<div ng-if="Moneda == 'U'">
											UF {{sumaNetoTotal | number:2}}
										</div> 
										<div ng-if="Moneda == 'P'">
											$ {{sumaNetoTotal | number:0}}
										</div> 
										<div ng-if="Moneda == 'D'">
											US$ {{sumaNetoTotal | number:2}}
										</div> 
									</td>
									<td></td>
								</tr>
								<tr ng-if="Moneda == 'U' || Moneda == 'P'">
									<td>Iva <span ng-if="exentoIva == true">Exento</span></td>
									<td> 
										<div ng-if="Moneda == 'U'">
											UF {{sumaIvaTotal | number:2}}
										</div> 
										<div ng-if="Moneda == 'P'">
											$ {{sumaIvaTotal}}
										</div> 
