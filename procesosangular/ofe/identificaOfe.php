												...
												?>
													<li style="list-style:none;"><b><?php echo $rowDp['itemPropuesta'].'.'.$rowIp['subItem'].' <i>'.$rowIp['titSubItem'].'</i>'; ?></b>
														<ul>
															<li style="list-style:none;">
																<?php 
																	echo $rowIp['descripcionSubItem']; 
																	$Visita = $rowOF['Visita'];
																	if($rowDp['itemPropuesta'] == 2 and $rowIp['subItem'] == 1){
																		if(isset($_GET['Visita'])){ $Visita = $_GET['Visita']; }
																		if($Visita == 'Si'){?>
																				Además contempla visitas a terreno, la cual debe estar establecida previamente entre las partes antes de iniciar el trabajo en cuestión.
																				<br>
																				<a class="btn btn-danger" href="index.php?OFE=<?php echo $OFE; ?>&accion=OFE&Visita=No">Quitar Visita</a>
																			<?php
																		}else{
																			?>
																				<br>
																				<a class="btn btn-primary" href="index.php?OFE=<?php echo $OFE; ?>&accion=OFE&Visita=Si">Incluir Visita</a>
																			<?php
																		}
																	}
																?> 
