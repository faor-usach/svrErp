	    	...
	    	<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<a class="navbar-brand" href="#">
	      		...
	      		<ul class="navbar-nav ml-auto">
	        		...
	        		<li class="nav-item active">
	          			<a class="nav-link fas fa-paste" href="../registroMat"> Muestras</a>
	        		</li>
	        		<?php
...
-->
			        		...
			        		<li class="nav-item active"  ng-if="CAM > 0 && OFE == 'on'">
			          			<a class="nav-link far fa-edit" href="ofe/index.php?OFE={{CAM}}&accion=OFE" title="Oferta Económica"> OFE</a>
			        		</li>
	        				<?php
	        			}
	        		?>
			...
			<div class="card">
				<div class="card-header">
					<div class="row">
						...
						<div class="col-md-2">
							<button class="{{btnCotZeroColor}}" ng-click="cotizacionZero()"> {{btnCotZero}} </button>
						</div>
					</div>
				</div>
			  	<div class="card-body" ng-show="datCAM">
			  		...
			  		<div class="row">
			  			<div class="col-3" ng-show="conCAM">
						  <div class="form-group">
			  			...
			  			<div class="col-3" ng-show="conCAM">
						  <div class="form-group">
				    			<input type="text" class="form-control" ng-model="Rev">
				    		</div>
				  		</div>
			  			<div class="col-6" ng-show="conCAM">
				  		</div>
			  			<div class="col-3">
						  <div class="form-group">
					  ...
					  <!--
						...
						-->
			  			...
			  			<div class="col-3">
				  			<div class="form-group">
				    			<label for="valorUS">Valor Dolar:</label>
			  		...
			  		<div class="row">
			  			<div class="col-12">
					  		<div class="form-group">
					    		<label for="obsServicios">Observaciones Generales:</label>
						  		<div class="col-12">
