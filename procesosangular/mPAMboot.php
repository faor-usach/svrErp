...
*/										
						...
						echo '	<td>';
									if($row['Estado'] == 'P'){ // En Proceso
										...
										if($OTAM == 'NO'){
											echo '<br><a href="../otams/pOtams.php?RAM='.$row['RAM'].'&CAM='.$row['CAM'].'&accion=Nuevo&prg=Procesos" data-toggle="tooltip" title="Crear Ensayos"><img src="../imagenes/materiales.png" 	width="22">					</a>';
										}else{
											echo '<br><a href="../otams/pOtams.php?RAM='.$row['RAM'].'&CAM='.$row['CAM'].'&accion=Old&prg="  data-toggle="tooltip" title="Ensayos"><img src="../imagenes/ensayos.png" 	width="22" >					</a>';
										}
									}
