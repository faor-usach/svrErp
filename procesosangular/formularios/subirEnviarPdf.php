...
<form action="https://simet.cl/erp/cotizaciones/recibePdf.php" method="post" enctype="multipart/form-data">
	...
	<input name="Contacto" 			type="text" id="Contacto" 			value="<?php echo $Contacto; ?>">
		...
		<tr>
			<td class="tituloTrianguloCorreo"><div class="triangulo"></div></td>
		  	<td class="tituloCorreo">
				...
				<div id="botonImagen">
					<?php 
						$prgLink = '../modCotizacion.php?CAM='.$CAM.'&Rev=0&Cta=0&accion=';
...
<main>
	<div class="adjoined-bottom">
		...
		<tr>
			<td colspan="2">
				<textarea name="Observacion"  id="editor" rows="5" cols="110"><?php echo $Observacion; ?></textarea>
			</td>
		</tr>
  		<tr>
  			<td colspan="2">
