<?php
	...
	if($rowCAM=mysqli_fetch_array($bdCAM)){
		...
		if($rowCli=mysqli_fetch_array($bdCli)){
			...
			$pdf->SetXY(145,$ln+4);
			if($rowCAM['Moneda']=='D'){
				$pdf->Cell(20,4,'Unitario US$',0,0,'C');
			}
			if($rowCAM['Moneda']=='U'){
			...
			while($rowdCAM=mysqli_fetch_array($bddCAM)){
					...
					$pdf->SetXY(145,$ln);
					if($rowCAM['Moneda']=='D'){
						$pdf->MultiCell(20,6,number_format($rowdCAM['unitarioUS'], 2, '.', ','),0,'R');
					}
					if($rowCAM['Moneda']=='U'){
					...
					$pdf->SetXY(165,$ln);
					if($rowCAM['Moneda']=='D'){
						$pdf->MultiCell(20,6,number_format($rowdCAM['NetoUS'], 2, '.', ','),0,'R');
					}
					if($rowCAM['Moneda']=='U'){
			...
			$pdf->SetXY(165,$ln);
			if($rowCAM['Moneda']=='D'){
				$pdf->MultiCell(20,5,number_format($totalUS, 2, '.', ','),0,'R');
			}
			if($rowCAM['Moneda']=='U'){
			...
			if($rowCAM['pDescuento']>0){
				...
				$pdf->SetXY(165,$ln);
				if($rowCAM['Moneda']=='D'){
					$pdf->MultiCell(20,5,number_format($rowCAM['NetoUS'], 2, '.', ','),0,'R');
				}
				if($rowCAM['Moneda']=='U'){
			...
			$pdf->SetXY(165,$ln);
			if($rowCAM['Moneda']=='D'){
				$pdf->MultiCell(20,5,number_format($rowCAM['IvaUS'], 2, '.', ','),0,'R');
			}
			if($rowCAM['Moneda']=='U'){
			...
			$pdf->SetXY(165,$ln);
			if($rowCAM['Moneda']=='D'){
				$pdf->MultiCell(20,5,number_format($rowCAM['BrutoUS'], 2, '.', ','),0,'R');
			}
			if($rowCAM['Moneda']=='U'){
