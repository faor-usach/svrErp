...
?>
			...
			<div id="BarraFiltro">
				...
				<!-- Fin Filtro -->
				Buscar...
				<input name="dBuscado" id="dBuscar" align="right" maxlength="80" size="80" placeholder="Usuario" title="Usuario a Buscar...">
			...
			<div id="BarraOpciones">
				...
				<?php if($_SESSION['Perfil'] == 'WebMaster'){?>
					...
					<div id="ImagenBarraLeft" title="Menú">
						<a href="Menus.php" title="Menú">
