	...
	<div id="Cuerpo">
		...
		<div id="CajaCpo">
			<div id="CuerpoTitulo">
				...
				<div id="ImagenBarra">
					<a href="plataformaHistorica.php" title="Volver">
			...
			<?php
				...
				$link=Conectarse();
				//$bdProv=$link->query("SELECT * FROM Clientes Order By Cliente Limit $inicio, $nRegistros");
				$bdProv=$link->query("SELECT * FROM Clientes Order By Cliente");
				if(isset($_POST['Buscar'])){
					$dBuscado = $_POST['dBuscado'];
					$bdProv=$link->query("SELECT * FROM Clientes Where RutCli Like '%".$dBuscado."%' || Cliente Like '%".$dBuscado."%' Order By Cliente");
				}
