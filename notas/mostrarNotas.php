...
?>
	...
	<div id="BarraOpciones">
		...
		<div id="ImagenBarraLeft">
			<a href="agregaDoc.php?accion=Agregar" title="Agregar Nota">
	...
	<div>
		<table class="table table-dark table-hover">
			<thead>
				<tr>
					<th height="40"  align="center"><strong>Ensayos Asociado(s)	</strong></td>
					<th align="center"><strong>Notas								</strong></td>
					<th colspan="2" rowspan="2" align="center"><strong>Acciones	</strong></td>
				</tr>
			</thead>
			<tbody>
			<?php
				...
				if($rowDoc=mysqli_fetch_array($bdDoc)){
					do{
						$tr = "table-light text-dark";
						if($rowDoc['idEnsayo']){
							$tr = 'table-success text-dark';
						}?>
