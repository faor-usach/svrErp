<?php
	...
	if($rowRAM=mysqli_fetch_array($bdRAM)){
		...
		$tOtams 	= mysqli_num_rows($result); // obtenemos el n�mero de Otams
				...
				if($rowMu=mysqli_fetch_array($bdMu)){
					do{
						if($nDur == 5){
							...
							$pdf->SetFont('Arial','B',10);
							$pdf->SetXY(10,220);
							$pdf->Cell(30,4,'Técnico responsable',0,0,'L');
