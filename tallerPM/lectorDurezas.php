    ...
    <div class="container-fluid">
        <div class="card mt-2">
            <div class="card-header font-weight-bold bg-primary text-white">
                <b>Dureza a Ensayar </b>
            </div>
            <div class="card-body">
                <button type="button" class="btn btn-primary m-2" ng-click="mostrarDurezas(x.RAM)" ng-repeat="x in dataDurezas"> 
                    {{x.RAM}} 
        ...
        <div class="card mt-2" ng-show="muestraOtamsTracciones">
            <div class="card-header font-weight-bold bg-primary text-white">
                <b>Doblados <h4>{{RAM}}</h4> </b>
            </div>
            <div class="card-body">
                <!-- <button type="button" class="btn btn-info m-2" ng-click="cargarResultadosEnsayos(x.idItem)" ng-repeat="x in dataDurezasOtam">  -->
                <a type="button" class="btn btn-info m-2" href="iDureza.php?Otam={{x.idItem}}&tpMedicion={{x.tpMuestra}}" ng-repeat="x in dataDurezasOtam"> 
                    {{x.idItem}} 
