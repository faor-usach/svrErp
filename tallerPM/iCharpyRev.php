				...
				<div class="col">
					<div class="contenedor d-md-flex">
						<div class="col">
							...
							<div class="contenedor d-md-flex">
								<div class="col">
									<input class="form-control" type="date" ng-model="fechaRegistro" ng-change="cambiaFecha()">
								</div>
								<div class="col">Tº Ens.</div>
								<div class="col"><input class="form-control" type="text" ng-model="Tem" ng-change="cambiaTem()"></div>
								<div class="col">Tº Amb.</div>
								<div class="col"><input class="form-control" type="text" ng-model="TemAmb" ng-change="cambiaTemAmb()"></div>
								<div class="col">% Hum.</div>
								<div class="col"><input class="form-control" type="text" ng-model="Hum" ng-change="cambiaHum()"></div>
							</div>
						</div>
						<div class="col">
							...
							<div class="contenedor d-md-flex">
								...
								<div class="col">
									<select class="form-control" ng-model="Entalle" ng-change="cambiaEntalle()">
								...
								<table class="table table-dark table-hover table-bordered">
									...
									<tbody class="table-striped">
										<tr class="table-primary text-center" ng-repeat="x in dataImpactos">
											...
											<td>
												<input type="text" maxlength="5" size="5"  ng-model="x.Ancho" ng-value="{{x.Ancho}}" ng-change="guardarRegAnc(x.Ancho, x.nImpacto)">
											</td>
											<td>
												<input type="text" maxlength="5" size="5" ng-model="x.Alto" value="{{x.Alto}}" ng-change="guardarRegAlt(x.Alto, x.nImpacto)">
											</td>
											<td>
												<input type="text" maxlength="5" size="5" ng-model="x.resEquipo" ng-value="{{x.resEquipo}}" ng-change="guardarRegEqui(x.resEquipo, x.nImpacto)">
											</td>
									...
									<tfoot class="table-primary">
										<tr class="text-center">
											<td colspan="10">
												<button type="button" class="btn btn-info" ng-click="Actualizando()" ng-show="botonActualiza">
													<i class="fas fa-calculator"></i>
													<b>Actualizar y Calcular</b>
												</button>
											</td>
