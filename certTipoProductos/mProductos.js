    ...
    app.controller('CtrlClientes', function($scope, $http)  { 
        ...
        $scope.loadDataCertificado = function(np){
            $scope.nProducto = np;
        ...
        $scope.guardarDatosCertificado = function(){
            ...
            .then(function(response){
                    $scope.rutRes = 'Registro grabado...'+nProducto+' '+$scope.Producto;
                    $scope.muestraBotones = true;
                    $scope.loadDataCertificado(nProducto);
            }, function(error) {
                $scope.errors = error.message;
                $scope.rutRes = error;
            });
        ...
        $scope.desabilitarDatos = function(){
            ...
            .then(function(response){
                    ...
                    $scope.loadDataCertificado($scope.nProducto);
            }, function(error) {
                $scope.errors = error.message;
                $scope.rutRes = error;
            });
