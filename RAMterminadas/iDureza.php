		...
		<div id="CajaCpo">
			<div id="CuerpoTitulo">
				...
				<strong style="color:#FFFFFF; padding:0px 5px 5px; margin:5px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:18px; ">
					<?php 
						echo 'Ensayo de Dureza (<span style="color:#000; font-size:20px;">'.$Otam.'</span>)'; 
					?>
				</strong>
												...
												$Tem = $rowOT['Tem'];
													...
													<table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #ccc; margin-top:5px;" align="center">
														<tr bgcolor="#E6E6E6" style="font-weight:700;" align="center">
															<td colspan="<?php echo $Ind; ?>" align="center">Dureza<br>
														...
														<tr bgcolor="#FFFFFF" align="center">
															<?php
																...
																for($in=1; $in<=$Ind; $in++) { 
																	...
																	$el_nIndenta 	= 'nIndenta_'.$in.'-'.$Otam;
																	$link=Conectarse();
																	$bdRegDu=mysql_query("SELECT * FROM regDoblado Where idItem = '".$Otam."' and nIndenta = '".$in."'");
																	if($rowRegDu=mysql_fetch_array($bdRegDu)){
