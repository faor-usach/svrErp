				...
				<div align="center" class="titulos" style="opacity:1;">
      				<div align="left" class="titulo">
        				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	          				...
	          				<tr>
	            				<td colspan="2">Servicio de Ingeniería Metalúrgica y Materiales - <strong style="color:#FFFFFF; font-size:20px; ">M&oacute;dulo Documentación Acreditación</strong> </td>
	          				</tr>
	          				<tr>
    	        				<td>
