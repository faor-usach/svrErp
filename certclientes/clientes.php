...
<body ng-app="myApp" ng-controller="CtrlClientes">
	    	...
	    	<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<a class="navbar-brand" href="#">
	      		...
	      		<ul class="navbar-nav ml-auto">
	        		...
	        		<li class="nav-item">
	          			<a class="nav-link fas fa-address-card text-dark" href="#" ng-click="verClientes()"> Clientes</a>
	        		</li>
	        		<li class="nav-item">
	          			<a class="nav-link fas fa-address-card text-dark" href="#" ng-click="verContactos()"> Contactos</a>
	        		</li>
	        		<li class="nav-item">
	          			<a class="nav-link fas fa-address-card text-dark" href="mClientes.php?RutCli="> +Cliente</a>
	        		</li>
	        		<li class="nav-item">
	...
	<div class="row bg-info text-white" style="padding: 10px;">
			...
			<div class="col-5">
				<input class="form-control" ng-change="loadClientes()" ng-model="bCliente" type="text">
			</div>
			<div class="col-1">
				Contacto 
			</div>
			<div class="col-5">
				<input class="form-control" ng-change="loadContactos()" ng-model="bContactos" type="text">
			</div>
	</div>
