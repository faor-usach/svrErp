...
if($Formulario == "F3B"){
	...
	if($Rut_JefeProyecto == $rutTitular){
		if($IdProyecto == 'IGT-1118'){
			$pdf->Cell(185,5,'Cristian Vargas Riquelme',0,0,"C");
		}else{
			$firmaJefeB = 'aaa.png';
			$pdf->Image('../../ft/TimbreDirector.png',140,$ln-20,20,20);
			// $pdf->Image('../../ft/'.$firmaJefe,40,$ln-40,40,40);
			$pdf->Image('../../ft/'.$firmaJefeB,150,$ln-35,35,35);
			$pdf->Cell(185,5,strtoupper(utf8_decode($NomDirector)),0,0,"C");
		}
	}else{
		$pdf->Image('../../ft/TimbreDirector.png',140,$ln-20,20,20);
		$pdf->Image('../../ft/'.$firmaJefe,30,$ln-35,35,35);
		$pdf->Image('../../ft/'.$firmaJefe,150,$ln-35,35,35);
		$pdf->Cell(185,5,strtoupper(utf8_decode($NomDirector)),0,0,"C");
	}
	...
	if($Rut_JefeProyecto == $rutTitular){
		if($IdProyecto == 'IGT-1118'){
			$pdf->Cell(150,5,utf8_decode('Decano Facultad de Ingeniería'),0,0,"C");
		}else{
			//$pdf->Cell(130,5,utf8_decode('Director de Depatamento o Jefe de Centro Costo'),0,0,"C");
			$pdf->Cell(185,5,utf8_decode('Director de Depatamento'),0,0,"C");
		}
	}else{
		//$pdf->Cell(130,5,utf8_decode('Director de Depatamento o Jefe de Centro Costo'),0,0,"C");
		$pdf->Cell(185,5,utf8_decode('Director de Depatamento'),0,0,"C");
...
if($Formulario == "F7"){
	...
	//Cell(LargoMarco ,AltoMarco, Txt, VerMarco, ,Centro)
	$pdf->Cell(70,5,utf8_decode($JefeProyecto),0,0,"C");
	$pdf->Cell(130,5,utf8_decode($NomDirector),0,0,"C");

	if($firmaJefe){
		$pdf->Image('../../ft/'.$firmaJefe,40,$ln-40,40,40);
	}
	$firmaDirector = 'aaa.png';
	$pdf->Image('../../ft/'.$firmaDirector,130,$ln-40,40,40);
	...
	$pdf->SetXY(20,$ln);
	$pdf->Cell(70,5,"Jefe de Proyecto",0,0,"C");
	$pdf->Cell(130,5,utf8_decode('Director de Departamento'),0,0,"C");
	$pdf->SetFont('Arial','',7);
