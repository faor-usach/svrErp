	<table width="100%" height="74"  border="0" align="center" cellpadding="0" cellspacing="0" class="degradadoNegro">
  		<tr>
				...
				<div align="center" class="titulos">
      				<div align="left" class="titulo">
        				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	          				...
	          				<tr>
	            				<td colspan="2">Servicio de Ingeniería Metalúrgica y Materiales - <strong style="color:#FFFFFF; font-size:20px; ">M&oacute;dulo Gastos</strong> </td>
	          				</tr>
	          				<tr>
    	        				<td>
