				...
				<div id="CajaCpo">
					...
					<div id="BarraOpciones">
						...
						<div id="ImagenBarraLeft" title="Calcular Sueldo">
							<?php
							echo '<a href="cSueldo2017.php?Proceso=1&Periodo='.$PeriodoPago.'" title="Calculo de Sueldo Funcionario">';
					...
					<?php
						...
						echo '			<td  width="10%" align="center"><strong>Haberes			</strong></td>';
						...
						if ($row=mysqli_fetch_array($bdProv)){
							do{
								...
								if ($rowSue=mysqli_fetch_array($bdSue)){
									...
									echo '	<td width="5%"><a href="cSueldo2017.php?Proceso=2&Run='.$row['Run'].'&Periodo='.$PeriodoPago.'"><img src="../gastos/imagenes/corel_draw_128.png"   width="22" height="22" title="Editar y Confirmar Pago"></a></td>';
									echo '	<td width="5%"><a href="cSueldo2017.php?Proceso=3&Run='.$row['Run'].'&Periodo='.$PeriodoPago.'"><img src="../gastos/imagenes/delete_32.png" 		 width="22" height="22" title="Eliminar"	></a></td>';
