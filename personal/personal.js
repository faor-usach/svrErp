    ...
    app.controller('CtrlPersonal', function($scope, $http) {
        ...
        $scope.CalcularRetencion = function(){
            // $scope.Retencion    = $scope.Total * 0.1075;
            $scope.Retencion    = $scope.Total * 0.1375;
            $scope.Liquido      = parseInt($scope.Total) - parseInt($scope.Retencion);
        }
