...
/* Encabezado Contrato */
	...
	$pdf->Image('../../gastos/logos/sdt.png',160,10,33,30);
...
/* Primer Parrafo Contrato */
	...
	$ln += 7;
	$pdf->SetY($ln);
	$LinTxt  = 'En Santiago, a '.$Fecha.', comparecen don '. utf8_decode($NomDirector).utf8_decode(', cédula nacional de identidad ').$RutDirector.utf8_decode(', en  nombre y representación de ');
...
/* Pie de Contrato */
	...
	if($firmaPrestador){
		$pdf->Image('../../ft/'.$firmaPrestador,130,190,40,40);
	}
...
/* Imprime Contrato */
	...
	//$pdf->Output('F3B-00001.pdf','F'); // Crea un ARchivo
