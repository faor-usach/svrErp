<?php
	...
	?>
		...
		function informesAcciones(){
				...
				$sql = "SELECT * FROM accionesCorrectivas Order By fechaApertura Desc";
				...
				if ($row=mysql_fetch_array($bdEnc)){
					do{
						...
						echo '	<td width="06%" align="center"><a href="accionesCorrectivas.php?nInformeCorrectiva='.$row[nInformeCorrectiva].'&accion=Actualizar"	><img src="../gastos/imagenes/corel_draw_128.png" 	width="40" height="40" title="Editar Acción Correctiva">		</a></td>';
