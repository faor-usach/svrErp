...
<div id="bloqueoTrasperente">
	<div id="cajaRegistraPruebas">
		<center>
		<form action="edicionInformes.php" method="post" enctype="multipart/form-data">
			...
			<tr>
				<td colspan="4" bgcolor="#0099CC" style="color:#FFFFFF; font-size:18px; ">
					...
					<span style="color:#FFFFFF; font-size:18px; font-weight:700;">
						...
						<div id="botonImagen">
							<?php 
								echo '<a href="edicionInformes.php?accion=Editar&CodInforme='.$CodInforme.'" style="float:right;"><img src="../imagenes/no_32.png"></a>';
							?>
						</div>
					</span>
				</td>
		    ...
		    <tr>
				<td colspan="4" bgcolor="#FFFFFF" style="color:#666666; border-top:1px solid; font-size:18px; ">
					<?php
						...
						if($accion == 'Editar'){?>
							<div id="botonImagen">
								<button name="subirGuardarFoto" style="float:right;" title="Subir Foto">
