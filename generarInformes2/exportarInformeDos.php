...
<body>
	...
	<?php 
		if($tpEnsayo == 2){
			include_once('textoAnalisisFalla.php'); 
		}
	?>
	<p class="blanco" >&nbsp;</p>
	...
	<?php 
		if($tpEnsayo == 2){
			...
			echo '<p class="blancoSubTitulos">';
				echo '<span style="text-decoration:underline;"><b>'.$letraItem.'.- Antecedentes:</b></span>';
			echo '</p>';
			?>
			<p class="blanco" >&nbsp;</p>
			<p class="txtEnsayos">
				<?php echo utf8_decode(stripcslashes(nl2br($Antecedentes))); ?>
			</p>
			<p class="blanco" >&nbsp;</p>
			<?php
		}
