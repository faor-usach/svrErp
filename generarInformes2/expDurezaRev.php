...
if($rowReg=mysqli_fetch_array($bdReg)){
	do{
		...
		if($rowReg['nIndenta'] == 1){
			$col_2_2 = array( 	'value' 			=> $rowReg['vIndenta'], 
								'backgroundColor' 	=> 'ffffff',
								'cellMargin'		=> 100,
								'borderBottom'		=> 'double',
							);
		...
		if($rowReg['nIndenta'] == 2){
			$col_2_3 = array( 	'value' 			=> $rowReg['vIndenta'], 
								'backgroundColor' 	=> 'ffffff',
								'cellMargin'		=> 100,
								'borderBottom'		=> 'double',
							);
		...
		if($rowReg['nIndenta'] == 3){
			$col_2_4 = array( 	'value' 			=> $rowReg['vIndenta'], 
								'backgroundColor' 	=> 'ffffff',
								'cellMargin'		=> 100,
								'borderBottom'		=> 'double',
							);
		...
		if($rowReg['nIndenta'] == 4){
			$col_2_5 = array( 	'value' 			=> $rowReg['vIndenta'], 
								'backgroundColor' 	=> 'ffffff',
								'cellMargin'		=> 100,
								'borderBottom'		=> 'double',
							);
		...
		if($rowReg['nIndenta'] == 5){
			$col_2_6 = array( 	'value' 			=> $rowReg['vIndenta'], 
								'backgroundColor' 	=> 'ffffff',
								'cellMargin'		=> 100,
								'borderBottom'		=> 'double',
							);
...
$mediaIndenta = $mediaIndenta / $nIndenta;
if($nIndenta == 3){
	$col_2_5 = array( 	'value' 			=> $mediaIndenta, 
						'backgroundColor' 	=> 'ffffff',
						'borderRight'		=> 'double',
						'borderBottom'		=> 'double',
					);
...
if($nIndenta == 4){
	$col_2_6 = array( 	'value' 			=> $mediaIndenta, 
						'backgroundColor' 	=> 'ffffff',
						'borderRight'		=> 'double',
						'borderBottom'		=> 'double',
					);
