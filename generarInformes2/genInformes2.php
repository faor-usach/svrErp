<?php 	
	...
	if($rowCot=mysqli_fetch_array($bdCot)){
		$nroInformes	= $rowCot['nroInformes'];
		$cooResponsable	= $rowCot['cooResponsable'];
	}
				...
				<tr>
					<td colspan="4" bgcolor="#0099CC" style="color:#FFFFFF; font-size:18px; ">
						...
						<span style="color:#FFFFFF; font-size:25px; font-weight:700;">
							Generaci&oacute;n de Informes <?php echo $CodInforme; ?>
							<div id="botonImagen">
								<?php 
									if($accion=='Vacio'){
										...
										$prgLink = 'nominaInformes.php?accion=Actualizar&CodInforme='.$CodInforme.'&RAM='.$RAM.'&RutCli='.$RutCli;
									}
				...
				<tr>
		  		...
		  		<tr>
					...
					<?php
						...
						if($accion == 'ReEditar'){?>
							<div id="botonImagen">
								<button name="RegenerarInformes" style="float:right;" title="Re Generar Informe(s)">
