...
?>
	...
	<div>
		<table border="0" cellspacing="0" cellpadding="0" id="CajaTilulo">
			<tr>
				<td  width=" 7%" height="40" style="padding-left:5px;" ><strong>Nota	</strong></td>
				<td  width="80%"><strong>Notas Cotizaciones								</strong></td>
		...
		<table border="0" cellspacing="0" cellpadding="0" id="CajaListado">
			<?php
				...
				$bdDoc=$link->query("SELECT * FROM cotizaNotas $filtroSQL Order By nNota"); 
