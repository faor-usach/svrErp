	    	...
	    	<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<a class="navbar-brand" href="#">
	      		...
	      		<ul class="navbar-nav ml-auto">
	        		...
	        		<li class="nav-item">
						<?php if($CodCertificado){?>
							<a class="nav-link fas fa-address-card text-dark" href="mProductos.php?nNorma=0&CodCertificado=<?php echo $CodCertificado; ?>"> +Norma</a>
							<?php
						}else{?>
							<a class="nav-link fas fa-address-card text-dark" href="mProductos.php?nNorma=0"> +Norma</a>
						<?php
						}
						?>
	        		</li>
	  	...
	  	<table class="table table-dark table-hover table-bordered" ng-show="tCertificados">
	    	...
	    	<tbody> 
	      		<tr ng-repeat="x in Productos | filter : bTipoProd"
			        ...
			        <td  class="text-center"><b>{{x.nNorma}}</b></td>
			        <td><b>{{x.Norma}}</b></td>
			        <td  class="text-center">
			        	<a 	class="btn btn-warning" role="button"
	        				href="mProductos.php?nNorma={{x.nNorma}}&CodCertificado=<?php echo $CodCertificado; ?>" >Editar</a>
	        		</td>
	      		</tr>
	    	</tbody>
	  </table>
