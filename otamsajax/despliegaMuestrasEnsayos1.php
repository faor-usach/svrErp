<form name="form" action="idMuestras2.php" method="get">
	<?php 	
	$RAM 		= $_GET[RAM];
	$idItem 	= $_GET[idItem];
	$accion  	= $_GET[accion];
	...
	if($rowMu=mysql_fetch_array($bdMu)){
		do{
			...
			$nTraccion 	= mysql_num_rows($result); // obtenemos el número de Otams Traccion
		...
		?>
		<br>
			<table width="99%"  border="0" cellpadding="0" cellspacing="0" id="tablaDatosAjax" align="center">
				<tr>
					<td colspan="4" bgcolor="#0099CC" style="color:#FFFFFF; font-size:18px; ">
						...
						<span style="color:#FFFFFF; font-size:25px; font-weight:700;">
							Muestra Id.SIMET <span style=" color:#FFFF00; font-weight:700; "> <?php echo $idItem; ?></span>
							<?php echo $Existe;?>
					  </span>
				  </td>
				</tr>
