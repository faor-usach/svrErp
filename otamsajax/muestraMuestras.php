<?php
	...
	$vDir = 'Y://AAA/LE/LABORATORIO/'.$agnoActual.'/'.$RAM.'/Du/Planos'; 
	if(!file_exists($vDir)){
		//mkdir($vDir);
	}
									...
									<div class="row">
										...
										<div class="col-4">
											<?php
												// $obsIng 		= 'Las probetas de impacto fueron ensayadas a 21 +/- 1°C, según especificación del cliente.';
												// $Comentarios 	= 'La muestra analizada cumple/no cumple (según corresponda) con la energía absorbida establecida por el cliente.';
												$sqlOtams = "SELECT * FROM Otams Where idItem = '$idItem'";
												$bdOtams=$link->query($sqlOtams);
												if($rsOt=mysqli_fetch_array($bdOtams)){
													$vReferencia = $rsOt['vReferencia'];
													$obsIng 	 = $rsOt['obsIng'];
													$Comentarios = $rsOt['Comentarios'];
													// if($rsOt['obsIng'] == ''){
														$obsIng 		= 'Las probetas de impacto fueron ensayadas a '.$rsOt['Tem'].' +/- 1°C, según especificación del cliente.';
														$Comentarios 	= 'La muestra analizada cumple/no cumple con la energía absorbida establecida por el cliente.';												
													// }
													// echo $vReferencia.' '.$idItem;
												}
										...
										<?php if($rowe['idEnsayo']=='Ch'){?>
											<div class="col-2" ng-show = 'conRef'>
												<div class="form-grup">
													<label for="Ref">V.Referencia:</label>
													<input name="vReferencia" type="text" value="<?php echo $vReferencia; ?>">
												</div>
											</div>
											<?php
										}; ?>
									...
									<?php 
										if($firstidEnsayo == 'Ch'){?>
											...
											<div class="row">
												<div class="col-6">
													<div class="form-grup">
														<label for="Ind">Obs.Ing.:</label>
														<textarea class="form-control" rows="5" name='obsIng' id="obsIng"><?php echo $obsIng; ?></textarea>
													</div>
												</div>
												<div class="col-6">
													<div class="form-grup">
														<label for="Ind">Comentarios:</label>
														<textarea class="form-control" rows="5" name='Comentarios' id="Comentarios"><?php echo $Comentarios; ?></textarea>
													</div>
												</div>
											</div>
											<?php
