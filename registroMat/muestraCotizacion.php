...
*/										
						...
						echo '	<td width="14%" align="center">';
								if($row[Estado] == 'P'){ // En Proceso
									echo '<a href="plataformaCotizaciones.php?CAM='.$row[CAM].'&RAM='.$row[RAM].'&accion=SeguimientoRAM"			><img src="../gastos/imagenes/klipper.png" 		width="40" height="40" title="Seguimiento">			</a><br>';
									echo '<a href="formularios/iCAM.php?CAM='.$row[CAM].'&Rev='.$row[Rev].'&Cta='.$row[Cta].'&accion=Reimprime"		><img src="/imagenes/informeUP.png" 			width="40" height="40" title="Seguimiento">			</a>';
								}else{
