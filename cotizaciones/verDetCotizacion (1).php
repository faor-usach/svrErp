	...
	<table width="98%" cellpadding="0" cellspacing="0">
		<tr>
			<td width="70%" valign="top">
				...
				$bdEnc=mysql_query("SELECT * FROM dCotizacion Where CAM = '".$CAM."' Order By nLin Asc");
				if ($row=mysql_fetch_array($bdEnc)){
					do{
						...
						echo '	</td>';
						echo '	<td width="45%">';
									$bdSer=mysql_query("SELECT * FROM Servicios Where Estado = 'on' and nServicio = '".$row['nServicio']."'");
