					...
					do{
						...
						echo '	<td width="10%" style="font-size:12px;">';
									if($row[fechaInicio] != 0){
										...
										echo '<br>';
										if($estadoDias == 'Normal'){ // En Proceso
											if($nDias == 1){ // En Proceso
												echo '<div class="pVencer" title="Días plazo RAM">';
												echo 	$nDias;
												echo '</div';
											}else{
										...
										if($estadoDias == 'Falta'){ // En Proceso
											echo '<div class="sVencer" title="Días plazo RAM">';
											echo 	$nDias;
											echo '</div';
										}
										if($estadoDias == 'Atrazada'){ // En Proceso
											echo '<div class="sVencer" title="Días plazo RAM">';
											echo 	$nDias;
											echo '</div';
										}
