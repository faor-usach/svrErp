	      		...
	      		<ul class="navbar-nav ml-auto">
	        		...
	        		<li class="nav-item">
						<?php if($CodCertificado){?>
							...
							<a class="nav-link fas fa-address-card text-dark" href="mProductos.php?nAcero=0"> +Acero</a>
						<?php
						}
						?>
	        		</li>
	  	...
	  	<table class="table table-dark table-hover table-bordered" ng-show="tCertificados">
	    	...
	    	<tbody> 
	      		<tr ng-repeat="x in Productos | filter : bTipoProd"
			        ...
			        <td  class="text-center"><b>{{x.nAcero}}</b></td>
			        <td><b>{{x.Acero}}</b></td>
			        <td  class="text-center">
			        	<a 	class="btn btn-warning" role="button"
	        				href="mProductos.php?nAcero={{x.nAcero}}&CodCertificado=<?php echo $CodCertificado; ?>" >Editar</a>
	        		</td>
	      		</tr>
	    	</tbody>
	  </table>
