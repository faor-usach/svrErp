	    	...
	    	<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<a class="navbar-brand" href="#">
	      		...
	      		<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
	          			<a class="nav-link fas fa-address-card text-dark" href="../certCamAR/index.php"> CAMAR</a>
	        		</li>
	        		...
	        		<li class="nav-item">
	          			<a class="nav-link fas fa-address-card text-dark" href="../certMAr/?ar=AR-"> +AR</a>
	        		</li>
	        		<li class="nav-item">
	  	...
	  	<table class="table table-dark table-hover table-bordered" ng-show="tCertificados">
	    	...
	    	<tbody> 
	      		<tr ng-repeat="x in Certificados | filter : bCertificado" 
			        ...
			        <td><b>{{x.ar}}</b></td>
			        <td><b>{{x.Cliente}}</b></td>
			        <td>{{x.fechaInspeccion | date:'dd-MM-yyyy'}}</td>
			        <td><b>{{x.nColadas}}</b></td>
			        <td><b>{{x.RAMAR}}</b></td>
			        <td>
			        	<!-- <a 	class="btn btn-warning" role="button" href="../certproductos?CodCertificado={{x.ar}}">Editar</a> -->
			        	<a ng-if="x.RAMAR>0"	class="btn btn-info" role="button" href="../otamsajax/pOtams.php?RAM={{x.RAMAR}}&OCP={{x.ar}}">Ensayos</a>
